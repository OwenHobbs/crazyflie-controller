...
class PIDGains:
    ...
    body_heading_offset_deg: float = 0.0

    # Altitude control in raw Crazyflie thrust units.
    hover_thrust: int = 54850
    kpz_thrust_per_m: float = 7000.0
    kdz_thrust_per_mps: float = 7000.0
    kiz_thrust_per_m_s: float = 1500.0
    z_integral_limit: float = 0.40
    z_integral_active_error_m: float = 0.30
    z_integral_bleed: float = 0.997
